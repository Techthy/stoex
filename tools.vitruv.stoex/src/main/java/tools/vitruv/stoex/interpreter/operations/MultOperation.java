...
// if (right == 0){
// throw new IllegalArgumentException("ProbabilityMassFunction
// "+left.toString()+" cannot be multiplied with 0, this operation is
// undefined.");
// }
...
// double right) throws DomainNotNumbersException {
// if (right == 0){
// throw new IllegalArgumentException("ProbabilityDensityFunction
// "+left.toString()+" cannot be multiplied with 0, this operation is
// undefined.");
// }
// return left.stretchDomain(right);
