...
// System.out.println(
// "Uniform PDF One - Value: " + sample.getValue() + ", Probability: " +
...
// BoxedPDF result = monteCarlo.monteCarloEstimation(uniformPDFOne,
// uniformPDFTwo);
...
// // System.out.println("Value: " + Math.round(sample.getValue() * 100.0) /
// 100.0
// // + ", CDF Probability: " +
...
// assertEquals("Result should have the same number of samples",
// uniformPDFOne.getSamples().size(),
