...
/**
 * Test that validates the ExpressionEvaluationDemo functionality.
 * This runs the same demos as ExpressionEvaluationDemo but in a test context.
 */
public class ExpressionEvaluationDemoTest {
    ...
    public void testExpressionEvaluationDemo() {
        try {
            ...
            System.out.println("=== ExpressionEvaluationVisitor Demo (Low-Level API) ===");
            ...
            // Demo 8: Probability distributions
            System.out.println("\n8. Probability Distributions:");
            Expression expr11 = parseExpression(resourceSet, "Normal(0, 1)");
            Object result11 = evaluator.doSwitch(expr11);
            System.out.println("   Normal(0, 1) = " + String.format("%.3f", (Double) result11));

            Expression expr12 = parseExpression(resourceSet, "Bernoulli(0.5)");
            Object result12 = evaluator.doSwitch(expr12);
            System.out.println("   Bernoulli(0.5) = " + result12);

            System.out.println("\n=== Low-Level Demo Complete ===");
            System.out.println("Note: This shows direct usage of ExpressionEvaluationVisitor");
            System.out.println("For high-level usage, see StoexEvaluator class instead.");
